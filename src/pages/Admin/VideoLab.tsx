...
export default function VideoLab() {
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            setProgressText('Engenharia de Prompts (Sora 2 Cinematic Engine v17.6)...');
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[9px] text-zinc-500 font-medium uppercase tracking-[0.2em]">Production Engine <span className="text-cyan-500">v17.6</span></p>
                        </div>
                    </div>
                </div>
                        ...
                        <motion.div key="s3" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
                            <div className="flex items-center justify-between mb-8">
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-[10px] text-zinc-500 mt-1 uppercase tracking-wider">DNA do Produto + Contexto de Marketing + Sora 2 Blueprint Engine v17.6</p>
                                </div>
                                <div className="flex items-center gap-3">
