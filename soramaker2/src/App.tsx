    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            for (let i = 0; i < prompts.length; i++) {
                ...
                const mockupUrl = await generateMockup(analysis.description, options, i, prompts[i]);
    ...
    const handleContinueFlow = async () => {
        ...
        try {
            ...
            for (let i = 0; i < newPrompts.length; i++) {
                ...
                const mockupUrl = await generateMockup(analysis.description, options, globalIndex, newPrompts[i]);
                setResults(prev => {
                    const updated = [...prev];
    ...
    const handleRegenerateTake = async (index: number) => {
        ...
        toast.promise(
            (async () => {
                ...
                const mockupUrl = await generateMockup(analysis.description, newOptions, index, newPrompt);
                setResults(prev => {
                    const updated = [...prev];
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[9px] text-zinc-500 font-medium uppercase tracking-[0.2em]">Production Engine</p>
                        </div>
                    </div>
                </div>
