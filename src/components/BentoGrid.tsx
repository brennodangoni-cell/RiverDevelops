            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-4 md:grid-rows-2 gap-4 h-[1200px] md:h-[600px]">
                    ...
                    <div className="md:col-span-2 md:row-span-2 rounded-3xl glass-panel p-8 relative overflow-hidden group">
                        <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-transparent opacity-0 group-hover:opacity-100  "></div>
                        ...
                        <div className="relative z-10 h-full flex flex-col justify-between">
                            ...
                            <div className="mt-8 rounded-xl bg-black/40 border border-white/5 h-64 overflow-hidden relative group-hover:border-primary/30 ">
                                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1626814026160-2237a95fc5a0?q=80&w=800&auto=format&fit=crop')] bg-cover bg-center opacity-60 group-hover:opacity-80  "></div>
                                ...
                                <div className="absolute bottom-4 left-4 right-4 h-12 bg-black/60 backdrop-blur-xl rounded-lg border border-white/5 flex items-center px-3 gap-3 overflow-hidden z-20">
                                    ...
                                    <div className="flex-1 h-8 flex gap-[2px] items-center relative overflow-hidden">
                                        ...
                                        <div className="absolute left-0 top-0 bottom-0 w-[2px] bg-primary -[0_0_15px_#38BDF8] animate-slide-right"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    {/* Medium Card 1 */}
                    <div className="md:col-span-1 md:row-span-2 rounded-3xl glass-panel p-8 relative overflow-hidden group ">
                        ...
                        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 text-5xl font-mono font-black text-white/5 group-hover:text-primary/20 ">4K</div>
                    </div>

                    {/* Small Card 1 */}
                    <div className="md:col-span-1 md:row-span-1 rounded-3xl glass-panel p-6 flex flex-col justify-center items-center text-center group hover:bg-white/5 ">
                        <Layers className="text-secondary mb-3 group-hover:rotate-180   " size={32} />
                        <h3 className="text-white font-bold font-display">Deep Layers</h3>
                    </div>

                    {/* Small Card 2 */}
                    <div className="md:col-span-1 md:row-span-1 rounded-3xl glass-panel p-6 flex flex-col justify-center items-center text-center group hover:bg-white/5 ">
                        <MousePointer2 className="text-accent mb-3 group-hover:scale-110 " size={32} />
