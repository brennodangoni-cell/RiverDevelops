...
// =======================================================================
const BRAIN_MODELS = ["gemini-3.1-pro-preview", "gemini-3.1-flash-image-preview"];
const ANALYSIS_MODELS = ["gemini-3.1-pro-preview", "gemini-3.1-flash-image-preview"];
const IMAGE_MODELS = ["gemini-3.1-flash-image-preview"];
