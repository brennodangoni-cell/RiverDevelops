                ...
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[9px] text-zinc-500 font-medium uppercase tracking-[0.2em]">Production Engine <span className="text-cyan-500">v18.4</span></p>
                        </div>
                    </div>
                </div>
                        ...
                        <motion.div key="s3" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-12">
                            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-4">
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-[10px] text-zinc-500 mt-3 uppercase tracking-widest">DNA do Produto + Contexto de Marketing + Sora 2 Blueprint Engine v18.4</p>
                                </div>
